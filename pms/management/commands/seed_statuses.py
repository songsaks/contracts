    ...
    def handle(self, *args, **options):
        ...
        SEED = {
            Project.JobType.PROJECT: [
                ...
                (Project.Status.PREPARING_DOCS, 'เตรียมเอกสารใบส่งสินค้า', 75),
            ...
            Project.JobType.REPAIR: [
                ...
                (Project.Status.PREPARING_DOCS, 'เตรียมเอกสารใบส่งสินค้า', 65),
            ...
            Project.JobType.SERVICE: [
                ...
                (Project.Status.PREPARING_DOCS, 'เตรียมเอกสารใบส่งสินค้า', 55),
