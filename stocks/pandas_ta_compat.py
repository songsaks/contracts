...
(ต่างกันแค่ระดับ 1e-8 ซึ่งเป็น floating point ปกติ) ยกเว้น bbands ดิบที่ 0.4.x
เปลี่ยนวิธีคิดส่วนเบี่ยงเบนมาตรฐาน ทำให้แถบบน/ล่างต่างไปจริง — แม้ความต่างนี้จะยัง
ไม่ทะลุถึงผลของฟังก์ชันสแกน (ทดสอบแล้ว 1645 ค่าตรงกันหมด) แต่ 0.4.x ต้องการ
Python >= 3.12 จึงไม่มีเหตุผลต้องรับความเสี่ยงนั้น
